...
function selectPhoto(photo, enc) {
	...
	$("#divRecuadro").css({"background-image": "url('"+(enc?decodeURIComponent(photo.replace(/\+/g, ' ')):photo)+"')", "background-repeat": "no-repeat", "background-size": "100% 100%"});
	$("#cameraImage").hide();
	$.colorbox.close();
}
function viewAlbums() {
...
<body>
	<div id="divGeneral">
    	...
    	<div id="divTxtBottom">
	    	<a href="index.php"><img src="img/anterior.png" border="0" /></a>&nbsp;&nbsp;<a href="step2.php"><img src="img/siguiente.png" border="0" /></a>
        </div>
    </div>
